...
const char * const BITCOIN_CONF_FILENAME =ALT_BITCOIN_CONF_FILENAME; //"bitcoin.conf";
const char * const BITCOIN_PID_FILENAME = ALT_BITCOIN_PID_FILENAME;//"bitcoind.pid";
