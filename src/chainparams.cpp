...
public:
    CMainParams() {
        ...
        consensus.nPowTargetTimespan = POW_TARGET_TIMESPAN; // two hour Jonathan MBC
        ...
        consensus.nRuleChangeActivationThreshold = 0.95* POW_TARGET_TIMESPAN/POW_TARGET_SPACING;//1916; // 95% of 2016
        consensus.nMinerConfirmationWindow = POW_TARGET_TIMESPAN/POW_TARGET_SPACING ; // nPowTargetTimespan / nPowTargetSpacing
        ...
        // vSeeds.push_back(CDNSSeedData("42.159.249.223", "42.159.249.223"));
           ...
           // vSeeds.push_back("192.168.18.138", true); 
           // vSeeds.push_back("192.168.18.139", true); 

         vSeeds.push_back(CDNSSeedData("192.168.18.138", "192.168.18.138"));
         vSeeds.push_back(CDNSSeedData("192.168.18.139", "192.168.18.139"));
